 ...
 * @author Kyle Truschel, modifications done to testing scenarios
 */
...
public class ListTester {
	...
	private void runTests() {
		...
		// [A]
		testSingleElementList(emptyList_addToFrontA_A, "emptyList_addToFrontA_A", LIST_A, STRING_A); // Test scenario
																										// given to us
		...
		testEmptyList(A_ListIterIndex1PreviousRemoveA_emptyList, "A_ListIterIndex1PreviousRemoveA_emptyList"); // 56
		// [B]
		...
		testTwoElementList(A_IterAddB_BA, "A_IterAddB_BA", LIST_BA, STRING_BA); // 63
		testTwoElementList(A_ListIterNextAddB_AB, "A_ListIterNextAddB_AB", LIST_AB, STRING_AB); // 64
		testTwoElementList(A_ListIterIndex1PreviousAddB_BA, "A_ListIterIndex1PreviousAddB_BA", LIST_BA, STRING_BA); // 65
		...
		testSingleElementList(A_ListIterIndex0NextASetB_B, "A_ListIterIndex0NextASetB_B", LIST_B, STRING_B); // 71
		testSingleElementList(A_ListIterIndex1PreviousSetB_B, "A_ListIterIndex1PreviousSetB_B", LIST_B, STRING_B); // 72
		// [B]
		...
		testSingleElementList(AB_ListIterIndex1PreviousARemoveA_B, "AB_ListIterIndex1PreviousARemoveA_B", LIST_B,
				STRING_B); // 57
		testSingleElementList(AB_ListIterIndex2PreviousBRemoveB_A, "AB_ListIterIndex1PreviousARemoveA_B", LIST_A,
				STRING_A); // 58
		// 2-element to 3-element
		testThreeElementList(AB_addToRearC_ABC, "AB_addToRearC_ABC", LIST_ABC, STRING_ABC);
		testThreeElementList(A_ListIterAddC_CAB, "A_ListIterAddC_CAB", LIST_CAB, STRING_CAB); // 66
		testThreeElementList(A_ListIterIndex0NextAddC_ACB, "A_ListIterIndex0NextAddC_ACB", LIST_ACB, STRING_ACB); // 67
		testThreeElementList(A_ListIterIndex1NextAddC_ABC, "A_ListIterIndex1NextAddC_ABC", LIST_ABC, STRING_ABC); // 68
		testThreeElementList(A_ListIterIndex1PreviousAddC_CAB, "A_ListIterIndex1PreviousAddC_CAB", LIST_CAB,
				STRING_CAB); // 69
		testThreeElementList(A_ListIterIndex2PreviousAddC_ACB, "A_ListIterIndex2PreviousAddC_ACB", LIST_ACB,
				STRING_ACB); // 70
		...
		testTwoElementList(AB_ListIterIndex0NextSetC_CB, "AB_ListIterIndex0NextSetC_CB", LIST_CB, STRING_CB); // 73
		testTwoElementList(AB_ListIterIndex1NextSetC_AC, "AB_ListIterIndex1NextBSetC_AC", LIST_AC, STRING_AC); // 74
		testTwoElementList(AB_ListIterIndex1PreviousSetC_CB, "AB_ListIterIndex1PreviousSetC_CB", LIST_CB, STRING_CB); // 75
		testTwoElementList(AB_ListIterIndex2PreviousSetC_AC, "AB_ListIterIndex2PreviousSetC_AC", LIST_AC, STRING_AC); // 76
		...
		testTwoElementList(ABC_ListIterIndex1PreviousRemoveA_BC, "ABC_ListIterIndex1PreviousRemoveA_BC", LIST_BC,
				STRING_BC); // 59
		testTwoElementList(ABC_ListIterIndex2PreviousRemoveB_AC, "ABC_ListIterIndex2PreviousRemoveB_AC", LIST_AC,
				STRING_AC); // 60
		testTwoElementList(ABC_ListIterIndex3PreviousRemoveC_AB, "ABC_ListIterIndex3PreviousCRemoveC_AB", LIST_AB,
				STRING_AB); // 61
		...
		testThreeElementList(ABC_ListIterIndex0NextSetD_DBC, "ABC_ListIterIndex0NextSetD_DBC", LIST_DBC, STRING_DBC); // 77
		testThreeElementList(ABC_ListIterIndex1NextSetD_ADC, "ABC_ListIterIndex1NextSetD_ADC", LIST_ADC, STRING_ADC); // 78
		testThreeElementList(ABC_ListIterIndex2NextSetD_ABD, "ABC_ListIterIndex2NextSetD_ABD", LIST_ABD, STRING_ABD); // 79
		testThreeElementList(ABC_ListIterIndex1PreviousSetD_DBC, "ABC_ListIterIndex1PreviousSetD_DBC", LIST_DBC,
				STRING_DBC); // 80
		testThreeElementList(ABC_ListIterIndex2PreviousSetD_ADC, "ABC_ListIterIndex2PreviousSetD_ADC", LIST_ADC,
				STRING_ADC); // 81
		testThreeElementList(ABC_ListIterIndex3PreviousSetD_ABD, "ABC_ListIterIndex3PreviousSetD_ABD", LIST_ABD,
				STRING_ABD); // 82
	 ...
	 * @return [] after iteratorRemoveAfterNextA
	 */
	private IndexedUnsortedList<Integer> A_ListIterIndex1PreviousRemoveA_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
	...
	private Scenario<Integer> A_ListIterIndex1PreviousRemoveA_emptyList = () -> A_ListIterIndex1PreviousRemoveA_emptyList();
	...
	/**
	 * Scenario: [A,B,C] -> listIterator removes A after previous -> [B,C]
	 * 
	 * @return [B,C] after listIterator removes A
	 */
	private IndexedUnsortedList<Integer> ABC_ListIterIndex1PreviousRemoveA_BC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
		// Start after A, at index 1, but before B
		ListIterator<Integer> lit = list.listIterator(1);
		lit.previous();
		lit.remove(); // Now remove the previous, which was A
		return list;
	...
	private Scenario<Integer> ABC_ListIterIndex1PreviousRemoveA_BC = () -> ABC_ListIterIndex1PreviousRemoveA_BC();

	/**
	 * Scenario: [A,B,C] -> listIterator removes B after previous -> [A,C]
	 * 
	 * @return [A,C] after listIterator removes B
	 */
	private IndexedUnsortedList<Integer> ABC_ListIterIndex2PreviousRemoveB_AC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
		// Start after B, at index 2, but before C
		ListIterator<Integer> lit = list.listIterator(2);
		lit.previous();
		lit.remove(); // Now remove the previous, which was B
		return list;
	...
	private Scenario<Integer> ABC_ListIterIndex2PreviousRemoveB_AC = () -> ABC_ListIterIndex2PreviousRemoveB_AC();

	/**
	 * Scenario: [A,B,C] -> listIterator removes C after previous -> [A,B]
	 * 
	 * @return [A,B] after listIterator removes C
	 */
	private IndexedUnsortedList<Integer> ABC_ListIterIndex3PreviousRemoveC_AB() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
		// Start after C, at index 3, but do not access null
		ListIterator<Integer> lit = list.listIterator(3);
		lit.previous();
		lit.remove(); // Now remove the previous, which was C
		return list;
	}
	 ...
	 * 
	 * @return [B,A] after Iterator add(A)
	 */
	...
	/**
	 * Scenario: [A] -> Iterator add(B) after next() -> [A,B]
	 * 
	 * @return [A] after Iterator add(B) after next()
	 */
	...
	/**
	 * Scenario: [A] -> Iterator add(B) after Index 1 previous() -> [A,B]
	 * 
	 * @return [A] after ListIter add(B) after Index 1 previous()
	 */
	private IndexedUnsortedList<Integer> A_ListIterIndex1PreviousAddB_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> lit = list.listIterator(1);
		lit.previous();
		lit.add(ELEMENT_B);
	...
	private Scenario<Integer> A_ListIterIndex1PreviousAddB_BA = () -> A_ListIterIndex1PreviousAddB_BA();
	 ...
	 */
	private IndexedUnsortedList<Integer> A_ListIterAddC_CAB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator();
		lit.add(ELEMENT_C);
		return list;
	...
	private Scenario<Integer> A_ListIterAddC_CAB = () -> A_ListIterAddC_CAB();

	/**
	 * Scenario: [A,B] -> Iterator add(C) after Index 0 A next() -> [A,C,B]
	 * 
	 * @return [A,C,B] after Iterator add(C) after Index 0 A next()
	 */
	private IndexedUnsortedList<Integer> A_ListIterIndex0NextAddC_ACB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
	...
	private Scenario<Integer> A_ListIterIndex0NextAddC_ACB = () -> A_ListIterIndex0NextAddC_ACB();

	/**
	 * Scenario: [A,B] -> Iterator add(C) after Index 1 B next() -> [A,B,C]
	 * 
	 * @return [A,B,C] after Iterator add(C) after Index 1 B next()
	 */
	private IndexedUnsortedList<Integer> A_ListIterIndex1NextAddC_ABC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator(1);
		lit.next();
		lit.add(ELEMENT_C);
	...
	private Scenario<Integer> A_ListIterIndex1NextAddC_ABC = () -> A_ListIterIndex1NextAddC_ABC();

	/**
	 * Scenario: [A,B] -> Iterator add(C) after A previous() -> [C,A,B]
	 * 
	 * @return [C,A,B] after Iterator add(C) after A previous()
	 */
	private IndexedUnsortedList<Integer> A_ListIterIndex1PreviousAddC_CAB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator(1);
		lit.previous();
		lit.add(ELEMENT_C);
	...
	private Scenario<Integer> A_ListIterIndex1PreviousAddC_CAB = () -> A_ListIterIndex1PreviousAddC_CAB();

	/**
	 * Scenario: [A,B] -> Iterator add(C) after B previous() -> [A,C,B]
	 * 
	 * @return [A,C,B] after Iterator add(C) after B previous()
	 */
	private IndexedUnsortedList<Integer> A_ListIterIndex2PreviousAddC_ACB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator(2);
		lit.previous();
		lit.add(ELEMENT_C);
	...
	private Scenario<Integer> A_ListIterIndex2PreviousAddC_ACB = () -> A_ListIterIndex2PreviousAddC_ACB();

	/////////////////////////////////
	// Set Iterator Tests for DLL //
	////////////////////////////////

	/**
	 * Scenario: [A] -> Iter set(B) after Index 0 A next() -> [B]
	 * 
	 * @return [B] after Iterator set(B) after Index 0 A next()
	 */
	private IndexedUnsortedList<Integer> A_ListIterIndex0NextASetB_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> lit = list.listIterator(0);
		lit.next();
		lit.set(ELEMENT_B);
	...
	private Scenario<Integer> A_ListIterIndex0NextASetB_B = () -> A_ListIterIndex0NextASetB_B();

	/**
	 * Scenario: [A] -> Iter set(B) after Index 1 previous() -> [B]
	 * 
	 * @return [B] after Iterator set(B) after Index 1 previous()
	 */
	private IndexedUnsortedList<Integer> A_ListIterIndex1PreviousSetB_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> lit = list.listIterator(1);
		lit.previous();
		lit.set(ELEMENT_B);
	...
	private Scenario<Integer> A_ListIterIndex1PreviousSetB_B = () -> A_ListIterIndex1PreviousSetB_B();

	/**
	 * Scenario: [A,B] -> Iter set(C) after Index 0 A next() -> [C,B]
	 * 
	 * @return [C,B] after Iterator set(C) after Index 0 A next()
	 */
	private IndexedUnsortedList<Integer> AB_ListIterIndex0NextSetC_CB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator(0);
		lit.next();
		lit.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_ListIterIndex0NextSetC_CB = () -> AB_ListIterIndex0NextSetC_CB();

	/**
	 * Scenario: [A,B] -> Iter set(C) after Index 1 B next() -> [A,C]
	 * 
	 * @return [C,B] after Iterator set(C) after Index 1 B next()
	 */
	private IndexedUnsortedList<Integer> AB_ListIterIndex1NextSetC_AC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator(1);
		lit.next();
		lit.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_ListIterIndex1NextSetC_AC = () -> AB_ListIterIndex1NextSetC_AC();

	/**
	 * Scenario: [A,B] -> Iter set(C) after B previous() -> [C,B]
	 * 
	 * @return [C,B] after Iterator set(C) after B previous()
	 */
	private IndexedUnsortedList<Integer> AB_ListIterIndex1PreviousSetC_CB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator(1);
		lit.previous();
		lit.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_ListIterIndex1PreviousSetC_CB = () -> AB_ListIterIndex1PreviousSetC_CB();

	/**
	 * Scenario: [A,B] -> Iter set(C) after Index 2 previous() -> [A,C]
	 * 
	 * @return [A,C] after Iterator set(C) after Index 2 previous()
	 */
	private IndexedUnsortedList<Integer> AB_ListIterIndex2PreviousSetC_AC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator(2);
		lit.previous();
		lit.set(ELEMENT_C);
	...
	/**
	 * Scenario: [A,B,C] -> Iter set(D) after next() -> [D,B,C]
	 * 
	...
	/**
	 * Scenario: [A,B,C] -> Iter set(D) after Index 1 next() -> [A,D,C]
	 * 
	 * @return [A,D,C] after Iterator set(D) after Index 1 next()
	 */
	...
	/**
	 * Scenario: [A,B,C] -> Iter set(D) after Index 2 next() -> [A,B,D]
	 * 
	 * @return [A,B,D] after Iterator set(D) after Index 2 next()
	 */
	...
	/**
	 * Scenario: [A,B,C] -> Iter set(D) after Index 1 previous() -> [D,B,C]
	 * 
	 * @return [D,B,C] after Iterator set(D) after Index 1 previous()
	 */
	...
	/**
	 * Scenario: [A,B,C] -> Iter set(D) after Index 2 previous() -> [A,D,C]
	 * 
	 * @return [A,D,C] after Iterator set(D) after Index 2 previous()
	 */
	...
	/**
	 * Scenario: [A,B,C] -> Iter set(D) after Index 3 previous() -> [A,B,D]
	 * 
	 * @return [A,B,D] after Iterator set(D) after Index 3 previous()
	 */
	...
	private void testEmptyList(Scenario<Integer> scenario, String scenarioName) {
		...
		try {
			...
			// Iterator
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException)); // Existential test,
																									// creates an
																									// iterator
	...
	private void testSingleElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents,
		...
		try {
			...
			printTest(scenarioName + "_testRemoveCharAt0" + contentsString.charAt(0),
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents,
		...
		try {
			...
			printTest(scenarioName + "_testRemoveCharAt0" + contentsString.charAt(0),
					testRemoveElement(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveCharAt1" + contentsString.charAt(1),
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents,
		...
		try {
			...
			printTest(scenarioName + "_testRemoveCharAt1" + contentsString.charAt(1),
					testRemoveElement(scenario.build(), contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveCharAt2" + contentsString.charAt(2),
			...
			printTest(scenarioName + "_iterNext2Remove_testIterNext", testIterNext(
			...
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(
					iterAfterNext(iterAfterRemove(iterAfterNext(scenario.build(), 1)), 1), Result.NoException));
			printTest(scenarioName + "_iterNext2RemoveNext_testIterHasNext", testIterHasNext(
					iterAfterNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), 1), Result.False));
			printTest(scenarioName + "_iterNext2RemoveNext_testIterNext", testIterNext(
					iterAfterNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), 1), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNext2RemoveNext_testIterRemove", testIterRemove(
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIter3PreviousNextRemove",
						testIterRemove(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 3), 3),
								Result.NoException));
